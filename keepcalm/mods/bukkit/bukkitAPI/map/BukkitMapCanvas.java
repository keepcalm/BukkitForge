...
public class BukkitMapCanvas implements MapCanvas {

    private final byte[] buffer = new byte[128 * 128];
    private final BukkitMapView mapView;
    private byte[] base;
    private MapCursorCollection cursors = new MapCursorCollection();

    protected BukkitMapCanvas(BukkitMapView mapView) {
        this.mapView = mapView;
        Arrays.fill(buffer, (byte) -1);
    }

    public BukkitMapView getMapView() {
        return mapView;
    }
    ...
    public void setPixel(int x, int y, byte color) {
        ...
        if (buffer[y * 128 + x] != color) {
            ...
            mapView.worldMap.setDirty(true);
        }
    }
