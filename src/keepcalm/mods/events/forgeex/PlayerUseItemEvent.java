...
public class PlayerUseItemEvent extends PlayerEvent {
	...
	public String toString() {
		return "keepcalm.mods.bukkit.events.PlayerUseItemEvent{stack=" + stack.getItem().getUnlocalizedName() + ", player=" + player.username + ", world=" + world.getWorldInfo().getVanillaDimension() + ", xCoord=" + x + ", yCoord=" + y + ", zCoord=" + z + ", blockface=" + dir.name();
	}
