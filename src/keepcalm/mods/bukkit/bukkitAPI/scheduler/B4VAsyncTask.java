...
class B4VAsyncTask extends B4VTask {

    private final LinkedList<BukkitWorker> workers = new LinkedList<BukkitWorker>();
    private final Map<Integer, B4VTask> runners;

    B4VAsyncTask(final Map<Integer, B4VTask> runners, final Plugin plugin, final Runnable task, final int id, final long delay) {
            ...
            workers.add(
                new BukkitWorker() {
                    ...
                    public int getTaskId() {
                        return B4VAsyncTask.this.getTaskId();
                    }

                    public Plugin getOwner() {
                        return B4VAsyncTask.this.getOwner();
                    }
                });
        }
