...
class BukkitMetaFirework extends BukkitMetaItem implements FireworkMeta {
    /*
    ...
    BukkitMetaFirework(BukkitMetaItem meta) {
        super(meta);

        if (!(meta instanceof BukkitMetaFirework)) {
            return;
        }

        BukkitMetaFirework that = (BukkitMetaFirework) meta;
    ...
    BukkitMetaFirework(NBTTagCompound tag) {
        super(tag);
    ...
    BukkitMetaFirework(Map<String, Object> map) {
        super(map);
    ...
    boolean notUncommon(BukkitMetaItem meta) {
        return super.notUncommon(meta) && (meta instanceof BukkitMetaFirework || isFireworkEmpty());
    }
    ...
    int applyHash() {
        ...
        return hash != original ? BukkitMetaFirework.class.hashCode() ^ hash : hash;
    }
    ...
    @Override
    public BukkitMetaFirework clone() {
        BukkitMetaFirework meta = (BukkitMetaFirework) super.clone();
