package org.bukkit.craftbukkit.v1_5_R2.help;
...
public class HelpYamlReader {
    ...
    public HelpYamlReader(Server server) {
        ...
        try {
        	defaultConfig = YamlConfiguration.loadConfiguration(getClass().getClassLoader().getResourceAsStream("configurations/help.yml"));
        	if (!new File("help.yml").exists()) {
				new File("help.yml").createNewFile();
				defaultConfig.save("help.yml");
			}
        }
        catch (Exception e) {
        	try {
