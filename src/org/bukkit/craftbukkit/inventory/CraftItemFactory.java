...
public final class CraftItemFactory implements ItemFactory {
    ...
    private ItemMeta getItemMeta(Material material, CraftMetaItem meta) {
        ...
        case WRITTEN_BOOK:
        case BOOK_AND_QUILL:
            return meta instanceof CraftMetaBook ? meta : new BukkitMetaBook(meta);
        case SKULL_ITEM:
            return meta instanceof CraftMetaSkull ? meta : new BukkitMetaSkull(meta);
        case LEATHER_HELMET:
        case LEATHER_CHESTPLATE:
        case LEATHER_LEGGINGS:
        case LEATHER_BOOTS:
            return meta instanceof CraftMetaLeatherArmor ? meta : new BukkitMetaLeatherArmor(meta);
        case POTION:
            return meta instanceof CraftMetaPotion ? meta : new BukkitMetaPotion(meta);
        case MAP:
            return meta instanceof CraftMetaMap ? meta : new BukkitMetaMap(meta);
        case FIREWORK:
            return meta instanceof CraftMetaFirework ? meta : new BukkitMetaFirework(meta);
        case FIREWORK_CHARGE:
            return meta instanceof CraftMetaCharge ? meta : new BukkitMetaCharge(meta);
        case ENCHANTED_BOOK:
            return meta instanceof CraftMetaEnchantedBook ? meta : new BukkitMetaEnchantedBook(meta);
        default:
    ...
    boolean equals(BukkitMetaItem meta1, CraftMetaItem meta2) {
        /*
