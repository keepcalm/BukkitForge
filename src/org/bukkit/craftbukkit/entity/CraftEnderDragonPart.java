...
public class CraftEnderDragonPart extends BukkitComplexPart implements EnderDragonPart {
    public CraftEnderDragonPart(BukkitServer server, EntityDragonPart entity) {
        super(server, entity);
    }
