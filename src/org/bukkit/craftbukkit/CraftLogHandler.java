...
public class CraftLogHandler extends Logger {
	private static final Logger theRealLogger = CraftContainer.bukkitLogger;
	...
	protected CraftLogHandler(String name, String resourceBundleName) {
		super(name, resourceBundleName);
		
		
	}
	public CraftLogHandler(String name) {
		super(name, FMLCommonHandler.instance().getFMLLogger().getResourceBundleName());
	}
	public CraftLogHandler() {
