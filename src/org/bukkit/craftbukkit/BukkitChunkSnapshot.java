 ...
 */
public class BukkitChunkSnapshot implements ChunkSnapshot {
    ...
    BukkitChunkSnapshot(int x, int z, String wname, long wtime, short[][] sectionBlockIDs, byte[][] sectionBlockData, byte[][] sectionSkyLights, byte[][] sectionEmitLights, boolean[] sectionEmpty, int[] hmap, BiomeGenBase[] biome, double[] biomeTemp, double[] biomeRain) {
        this.x = x;
        this.z = z;
