package org.bukkit.craftbukkit.v1_5_R3.enchantment;
...
public class CraftEnchantment extends Enchantment {
    ...
    public boolean canEnchantItem(ItemStack item) {
        return target.canApplyAtEnchantingTable(new net.minecraft.item.ItemStack(Item.itemsList[item.getTypeId()]));
    }
