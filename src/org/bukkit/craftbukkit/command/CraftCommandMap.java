 ...
 * {@inheritDoc}
 */
public class CraftCommandMap extends SimpleCommandMap implements CommandMap  {
    ...
    public CraftCommandMap(final Server server) {
    	//super(server);
    	super(server);
        this.server = server;
    ...
    private void setDefaultCommands(final Server server) {
        ...
        //register("bukkit", new CraftCommandVanish());
    }
